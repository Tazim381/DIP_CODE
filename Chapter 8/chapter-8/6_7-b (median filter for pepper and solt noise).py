...
# Apply the median filter to denoise the images
denoised_image_5 = apply_median_filter(noisy_image_5)
denoised_image_10 = apply_median_filter(noisy_image_10)
denoised_image_20 = apply_median_filter(noisy_image_20)
